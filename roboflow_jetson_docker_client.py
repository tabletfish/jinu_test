...
# - This file uses Roboflow's official InferenceHTTPClient.
# - MODEL_ID and ROBOFLOW_API_KEY are kept in this file so importing the direct
#   InferencePipeline example is not required.
